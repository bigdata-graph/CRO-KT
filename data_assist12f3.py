...
class DataProcess():
    ...
    def read_user_sequence3(self, filename, max_len=200, min_len=3, shuffle_flag=True):
        ...
        np.savez(os.path.join("assist12", "assist12f3.npz"), problem=problem, y=y, skill=skill,
                 real_len=real_len, skill_num=skill_num, problem_num=pro_num)
...
if __name__ == '__main__':
    ...
    # DP.process_csv()
    # DP.pro_skill_graph()
    # DP.generate_user_sequence1('data1.txt')
    ...
    DP.read_user_sequence3(os.path.join(data_folder, 'dataf3.txt'))
