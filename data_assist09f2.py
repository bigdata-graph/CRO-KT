...
class DataProcess():
    ...
    def read_user_sequence3(self, filename, max_len=200, min_len=3, shuffle_flag=True):
        ...
        np.savez(os.path.join(self.data_folder, "%s.npz" % 'assist09f2'), problem=problem, y=y, skill=skill,
                 real_len=real_len, skill_num=skill_num, problem_num=pro_num)
...
if __name__ == '__main__':
    ...
    DP.generate_user_sequence1('dataf2.txt')
    ...
    DP.read_user_sequence3(os.path.join(data_folder, 'dataf2.txt'))
